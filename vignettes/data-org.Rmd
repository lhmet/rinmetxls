...
#<img src="pscreen-excel-data.png" width="80%">
#dir(here::here("vignettes"))
#fs::dir_ls(system.file("vignettes", package = "rinmetxls"))
#fig_path <- system.file("vignettes/pscreen-excel-data.png", package = "rinmetxls")
